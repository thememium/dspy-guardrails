# DSPy Guardrails Contributing Guide

Hi! I'm really excited that you are interested in contributing to DSPy Guardrails. Before submitting your contribution, please make sure to take a moment and read through the following guidelines:
...
This is equivalent to `uv run dspy-guardrails --help`.
...
├── src/dspy_guardrails/             # Source code
...
- Use absolute imports from the `dspy_guardrails` package for local modules
...
from dspy_guardrails.cli.commands.concurrent_command import ConcurrentCommand
...
Thank you to all the people who have already contributed to DSPy Guardrails!

<a href="https://github.com/thememium/dspy-guardrails/graphs/contributors"><img src="https://contrib.rocks/image?repo=thememium/dspy-guardrails" /></a>
