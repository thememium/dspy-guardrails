...
def create_comprehensive_guardrail_suite(
    ...
    Note: DSPy must be configured globally before using these guardrails.
    Use dspy.configure(lm=your_lm) to set up DSPy.
    ...
    jailbreak_config = JailbreakGuardrailConfig()
    ...
    injection_config = PromptInjectionGuardrailConfig()
    ...
    secret_config = SecretKeysGuardrailConfig()
